...
CREATE TABLE IF NOT EXISTS passim_aoms (
    ...
    fiche_transbus_tc TEXT,
    type_usagers_tous BOOLEAN,
    type_usagers_pmr BOOLEAN,
    type_faibles_revenus BOOLEAN,
    type_recherche_emplois BOOLEAN,
    type_soins_medicaux BOOLEAN,
    type_personnes_agees BOOLEAN,
    type_scolaires BOOLEAN,
    type_touristes BOOLEAN,
    niveau TEXT,
    type_de_transport TEXT,
    sous_type_de_transport TEXT,
    mode_autocar BOOLEAN,
    mode_bateau BOOLEAN,
    mode_bus BOOLEAN,
    mode_bus_navette BOOLEAN,
    mode_funiculaire BOOLEAN,
    mode_metro BOOLEAN,
    mode_taxi BOOLEAN,
    mode_telepherique BOOLEAN,
    mode_train BOOLEAN,
    mode_tramway BOOLEAN,
    notes TEXT,
